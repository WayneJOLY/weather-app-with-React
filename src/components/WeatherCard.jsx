  ...
  <div className="card2">
    <div className="upper">
      <div className="humidity">
        <div class="humiditytext">Humidity {weather?.main.humidity} %</div>
      ...
      <div className="air">
        <div className="airtext">Wind {weather?.wind.speed} Km/h</div>
          <svg className="airsvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 30 30" xml:space="preserve">  <image id="image0" width="30" height="30" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAMAAAAM7l6QAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
    ...
    <div className="lower">
      <div className="aqi">
        <svg className="aqisvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xml:space="preserve">  <image id="image0" width="20" height="20" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
        ...
        <div className="aqitext">AQI 30</div>
      </div>

      <div className="realfeel">
        <svg className="rfsvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xml:space="preserve">  <image id="image0" width="20" height="20" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
        ...
        <div className="realfeeltext">Real Feel {temp?.feels_like} °C</div>
      </div>
      ...
      <div className="pressure">
        ...
        <div className="pressuretext">Pressure <span>{weather?.main.pressure}</span><span>hpa</span></div>
      </div>
      <div className="card3">
